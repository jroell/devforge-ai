...
import { Binary, Eraser, ArrowRightFromLine } from 'lucide-react'
...
function isBase64(text: string): boolean {
  return /^[A-Za-z0-9+/]{20,}={0,2}$/.test(text.trim())
}
    ...
    <div className="flex h-full flex-col gap-3 p-4">
      ...
      >
        ...
        <TabsContent value="encode" className="flex min-h-0 flex-1 flex-col gap-3">
          ...
          <OutputPanel label="Base64 Output" value={output} placeholder="Encoded output will appear here..." />
        </TabsContent>
